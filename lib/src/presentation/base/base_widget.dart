  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<T>(
      ...
      child: Consumer<T>(
        ...
        child: buildUi(context: context, defaultWidget: widget.child),
      ),
    );
  }
...
abstract class ResponsiveWidget {
  ...
  Widget buildUi({required BuildContext? context, Widget? defaultWidget, bool? fullRed}) {
    return GestureDetector(
      ...
      // bottomColor: fullRed != null ? AppColors.primary : Colors.white,
    );
  }
