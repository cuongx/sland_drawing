...
class AppPrefs {
  ...
  // }
  static set provinceGeo(ProvinceModel province) => _box.write('province', province);

  static ProvinceModel get provinceGeo {
    final _ = _box.read('province');
    if (_ == null) return ProvinceModel();
    return _ is ProvinceModel ? _ : ProvinceModel.fromJson(_box.read('province'));
  }
