...
class AppClients extends DioForNative {
  ...
  factory AppClients({String baseUrl = AppEndpoint.BASE_API_URL, BaseOptions? options}) {
  ...
  AppClients._({String baseUrl = AppEndpoint.BASE_API_URL, BaseOptions? options}) : super(options) {
